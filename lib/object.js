...
var ObjectSchema = function (_BaseSchema) {
    ...
    function ObjectSchema(parseSchema) {
        _classCallCheck(this, ObjectSchema);

        var _this = _possibleConstructorReturn(this, (ObjectSchema.__proto__ || Object.getPrototypeOf(ObjectSchema)).call(this, 'object'));
    ...
    _createClass(ObjectSchema, [{
        ...
        value: function parse(config, engine) {
            ...
            var state = { schema: engine.object(), engine: engine };
