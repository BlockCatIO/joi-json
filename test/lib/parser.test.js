  ...
  describe("Parser", function() {
    ...
    describe(".parse", function() {
      ...
      it("alternatives type (with type specified)", function() {
        ...
        expect(alternativesSchema.try.withArgs(schema1, schema2).calledOnce).to
          .be.true;
      });
      ...
      it("unknown type", function() {
        ...
        expect(parser.parse.bind(parser, config)).to.throw(
          "unknown type: special",
        );
      });
    ...
    describe(".buildSchema", function() {
      it("normal operation", function() {
        ...
        let returnValue = Parser.buildSchema(
